...
#    Updated: 2017/09/27 18:19:40 by quintonpo        ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strtrim.c ft_putchar.c ft_putstr.c ft_putendl.c ft_putnbr.c ft_putchar_fd.c \
...
ft_strtrim.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o ft_putchar_fd.o \
